...
# Use custom storage backend that returns public URLs without signing
...
# 🚀 ENTERPRISE: Credentials configuration
# Use Application Default Credentials (works automatically in Cloud Run)
GS_CREDENTIALS = None

# 🚀 ENTERPRISE: No ACL with uniform bucket-level access
# Use None for ACL and rely on bucket-level IAM permissions
GS_DEFAULT_ACL = None
...
# 🚀 ENTERPRISE: Media URL - will be generated by custom storage backend
